...
public class ActiveAdapter extends RecyclerView.Adapter<ActiveAdapter.ListViewHolder> {
    private List<ActiveVo> activeVos;
    private BaseFragment.OnItemClickListener listener;
    private Context context;
    private View.OnClickListener btnListener;

    public ActiveAdapter(List<ActiveVo> activeVos) {
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            details = itemView.findViewById(R.id.btn_active_details);
            apply = itemView.findViewById(R.id.btn_active_apply_now);
        }
    }
}
