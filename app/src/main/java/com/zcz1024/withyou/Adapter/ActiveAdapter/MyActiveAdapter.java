...
public class MyActiveAdapter extends RecyclerView.Adapter<MyActiveAdapter.ListViewHolder> {
    private List<ActiveVo> activeVos;
    private BaseFragment.OnItemClickListener listener;
    private Context context;
    private View.OnClickListener btnListener;

    public MyActiveAdapter(List<ActiveVo> activeVos) {
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context)
                .inflate(R.layout.item_my_active, parent, false);
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, final int position) {
       ...
       /* if (active.getActPic()!=null)
        ...
        holder.checkapply.setOnClickListener(btnListener);
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            details = itemView.findViewById(R.id.btn_myactive_details);
            checkapply = itemView.findViewById(R.id.btn_myactive_check_apply);
        }
    }
}
